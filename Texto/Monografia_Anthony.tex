...
\end{align*}
Ela é chamada de \textit{aplicação induzida na homologia}. Podemos denotá-lo, também, por $f_*$ em vez de $(f_n)_*$. Explicitamente, a aplicação $(f_n)_*$ pode ser descrito da seguinte forma:
\[
